...
abstract class AbstractMessageDigest extends MessageDigest {
	 ...
	 *
	 * @param algorithm     The (JCA) name of the algorithm.
	 * @param digestLength_ The length of a hash value in bytes.
	 * @param blockSize_    The input block size of the compression function in bytes.
	 */
	 ...
	 *
	 * @param input the byte to be used for updating.
	 */
	@Override
	 ...
	 *
	 * @param input  the byte array holding the data to be used for this update
	 *               operation.
	 * @param offset the offset, indicating the start position within the given byte
	 *               array.
	 * @param len    the number of bytes to be obtained from the given byte array,
	 ...
	 *
	 * @param input  The buffer_ that contains the input block.
	 * @param offset The offset where in the input buffer_ the block starts.
	 */
	 ...
	 *
	 * @param output The buffer_ where to put the hash value.
	 * @param offset The offset in the buffer_ where to start writing the hash.
	 */
