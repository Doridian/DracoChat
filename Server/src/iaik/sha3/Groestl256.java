 ...
 * value.
 * <p>
 * The <i>Groestl-256</i> message digest algorithm produces a 256-bit hash-value
 ...
 * there to create a MessageDigest-Groestl object. Generally, an application
 ...
 * 
 * <pre>
 * MessageDigest groestl = MessageDigest.getInstance(&quot;Groestl256&quot;);
 * </pre>
 * 
 * </blockquote>
 * <p>
 ...
 * 
 * <pre>
 * byte[] hash_value = groestl.digest();
 * </pre>
 * 
 * </blockquote>
 * </ul>
 ...
 * implements the <code>Cloneable</code> interface, Groestl MessageDigest
 * objects may be used for compute intermediate hashes through cloning (see <a
 * href =
 ...
 * <p>
 * When the hash value successfully has been computed, the Groestl MessageDigest
 ...
 */
public final class Groestl256 extends Groestl {

  private final static int DIGEST_LENGTH = 32;
