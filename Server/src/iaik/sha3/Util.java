...
final class Util {
	 ...
	 * </blockquote>
	 *
	 * @param block the byte array of which some bytes have to be set to zero
	 * @param off   the offset indicating the start position within the byte array;
	 *              the following <code>len</code> bytes are set to zero
	 * @param len   the number of bytes to be set to zero, starting at
	 *              <code>off</code>
	 */
	 ...
	 * </blockquote>
	 *
	 * @param inInts   the int array supplying the integers to be spread to bytes
	 * @param inOff    the offset indicating the start position within the input int
	 *                 array; the following <code>intLen</code> integers will be spread
	 *                 to bytes
	 * @param outBytes the byte array to which the resulting byte values are written,
	 *                 starting at position <code>outOff</code>
	 * @param outOff   the offset indicating the start position within the destination
	 *                 byte array, to which the resulting byte values are written
	 * @param intLen   the number of int values that have to spread to bytes
	 */
	 ...
	 * <p/>
	 *
	 * @param block the byte array to be filled with zeros
	 */
	 ...
	 * </blockquote>
	 *
	 * @param inBytes the byte array supplying the bytes to be squashed to ints
	 * @param inOff   the offset indicating the start position within the input byte
	 *                array; the following <code>4 * intLen</code> bytes will be
	 *                squashed to ints
	 * @param outInts the int array to which the resulting int values are written,
	 *                starting at position <code>outOff</code>
	 * @param outOff  the offset indicating the start position within the destination
	 *                int array, to which the resulting int values are written
	 * @param intLen  the number of int values that will result from the "bytes-to-ints"
	 *                transformation
	 */
	 ...
	 * </blockquote>
	 *
	 * @param inLongs  the long array supplying the integers to be spread to bytes
	 * @param inOff    the offset indicating the start position within the input int
	 *                 array; the following <code>intLen</code> integers will be spread
	 *                 to bytes
	 * @param outBytes the byte array to which the resulting byte values are written,
	 ...
	 * @param outOff   the offset indicating the start position within the destination
	 *                 byte array, to which the resulting byte values are written
	 * @param longLen  the number of long values that have to spread to bytes
	 */
	 ...
	 *                 array; the following <code>4 * intLen</code> bytes will be
	 *                 squashed to longs
	 * @param outLongs the long array to which the resulting int values are written,
	 *                 starting at position <code>outOff</code>
	 * @param outOff   the offset indicating the start position within the destination
	 *                 int array, to which the resulting int values are written
	 * @param longLen  the number of long values that will result from the
